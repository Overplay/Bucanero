...
import static io.ourglass.bucanero.tv.Views.OurglassHdmiDisplay2.OGHdmiState.SURFACE_DESTROYED;
import static io.ourglass.bucanero.tv.Views.OurglassHdmiDisplay2.OGHdmiState.SURFACE_READY;

public class OurglassHdmiDisplay2 {
    ...
    public interface OGHdmiListener {
    ...
    private OGHdmiListener mListener;
    ...
    /**
     * OurglassHdmiDisplay2
     *
     * @param mContext
     * @param viewGroupToInsertSurfaceViewInto
     */
    public OurglassHdmiDisplay2(Context mContext, ViewGroup viewGroupToInsertSurfaceViewInto, OGHdmiListener listener) {
        ...
        if (mHDMIRX == null) {
            ...
            if (rxStatus == null) {
                ...
                if (mHDMIRX.open() != 0) {
                    ...
                    Log.d(TAG, "initHDMIDriver: Could not open driver. Probably we are fucked.");
