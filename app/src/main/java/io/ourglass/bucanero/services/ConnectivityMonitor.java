package io.ourglass.bucanero.services;
...
import io.ourglass.bucanero.tv.WiFi.NetworkChangeMessage;
...
public class ConnectivityMonitor {
    ...
    public  WifiManager wifiManager = (WifiManager) ABApplication.sharedContext.getSystemService(Context.WIFI_SERVICE);
    public  ConnectivityManager connectivityManager = (ConnectivityManager) ABApplication.sharedContext.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    class NetworkChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            ABApplication.ottobus.post(new NetworkChangeMessage("NetChanged!"));
    ...
    public void startWiFiScan(){
        ...
        ABApplication.sharedContext.registerReceiver(mWiFiReceiver, new IntentFilter(WifiManager.SCAN_RESULTS_AVAILABLE_ACTION));
    ...
    public void stopWiFiScan(){
        ...
        try {
            ABApplication.sharedContext.unregisterReceiver(mWiFiReceiver);
        } catch (Exception e){
    ...
    private void processScanList(List<ScanResult> inboundList){
        ...
        ABApplication.ottobus.post(mWiFiScanResults);
